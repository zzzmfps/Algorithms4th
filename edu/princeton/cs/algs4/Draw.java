...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * Shade of orange used in Princeton's identity. It is PMS 158. The RGB values
     * are approximately (245, 128, 37).
     */
     ...
     *
     * @param value the value, typically {@code JFrame.EXIT_ON_CLOSE} (close all
     ...
     * key). It can handle action keys (such as F1 and arrow keys) and modifier keys
     * (such as shift and control). See {@link KeyEvent} for a description of key
     * codes.
     *
